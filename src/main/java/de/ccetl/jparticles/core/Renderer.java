...
public interface Renderer {
    ...
    void drawCircle(double x, double y, double radius, double degrees, int color);

    void drawTriangle(double x, double y, double radius, double degrees, int color);

    void drawStar(double x, double y, double radius, int sides, double dent, double degrees, int color);

    void drawImage(double x, double y, double radius, double degrees, int id);
